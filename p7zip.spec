...
Source0  : https://github.com/p7zip-project/p7zip/archive/v17.05/p7zip-17.05.tar.gz
...
%prep
%setup -q -n p7zip-17.05
cd %{_builddir}/p7zip-17.05
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677197569
